...
const randomNimek = async (type) => {
    ...
    switch (type) {
        case "nsfw":
            ...
            if (!nsfw.ok)
                throw new Error(`unexpected response ${nsfw.statusText}`);
        ...
        case "anime":
            ...
            if (!anime.ok)
                throw new Error(`unexpected response ${anime.statusText}`);
        ...
        case "neko":
            ...
            if (!neko.ok)
                throw new Error(`unexpected response ${neko.statusText}`);
        ...
        case "trap":
            ...
            if (!trap.ok)
                throw new Error(`unexpected response ${trap.statusText}`);
